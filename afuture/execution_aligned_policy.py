...
class ExecutionAlignedAggressivePolicy:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            or self.meta_score_source not in (META_SCORE_SOURCE, HOLDING_SCORE_SOURCE)
        ):
    ...
    def weight_history(
        ...
        *,
        ...
        if self.meta_score_source == HOLDING_SCORE_SOURCE and specific_contracts is None:
        ...
        if self.meta_score_source == HOLDING_SCORE_SOURCE:
