...
def evaluate(specific_raw: pd.DataFrame, basis_raw: pd.DataFrame) -> dict:
    ...
    return {
        ...
        "source_field_semantics": "AKShare 1.18.84 dom_basis_rate = dominant_futures / spot - 1",
        "signal_definition": "D completed carry = -sign(dom_basis_rate) -> D+1 equal-gross direction",
        "threshold": None,
        "lookback": None,
        "ranking": None,
