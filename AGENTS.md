...
- After applicable `AGENTS.md`, read the project brief, relevant README sections, matching PR/diff, and directly affected code, tests, configuration and workflows as needed. Expand only to resolve uncertainty or impact. Keep exact constraints and evidence identities intact; do not preload every skill, document or log.
