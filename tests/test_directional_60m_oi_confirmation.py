...
def _api():
    ...
    return build_daily_price_oi_flow, lag_flow_to_target_days, apply_oi_confirmation_to_weights
...
def test_daily_flow_uses_same_day_highest_final_oi_contract_and_requires_oi_growth():
    ...
    # AG2608 has higher final OI but OI fell, so the product has no confirming flow.
