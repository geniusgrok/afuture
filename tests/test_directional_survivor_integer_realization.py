...
def test_recovery_uses_only_floor_or_one_ceil_and_preserves_direction():
    ...
    result = recover(
        ...
        ideal_lots={"A2501": 1.7, "M2501": -1.2},
...
def test_equal_fractional_tie_is_deterministic_and_half_rounds_down():
    ...
    result = recover(
        floor_lots={},
        ideal_lots={"M2501": 0.8, "A2501": 0.8, "C2501": 0.5},
        lot_notionals={"M2501": 100.0, "A2501": 100.0, "C2501": 100.0},
        per_lot_margin={"M2501": 10.0, "A2501": 10.0, "C2501": 10.0},
        gross_budget=160.0,
        margin_budget=30.0,
        max_contract_volume=35,
    )
