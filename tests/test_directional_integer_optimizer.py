...
def test_optimizer_never_exceeds_requested_magnitude():
    result = optimize(
        reference_lots={"AG2612": 1},
        requested_lots={"AG2612": 1},
        current_lots={"AG2612": 1},
        lot_notionals={"AG2612": 100000.0},
        per_lot_margin={"AG2612": 15000.0},
...
def test_optimizer_never_exceeds_35_lots():
    result = optimize(
        reference_lots={"AG2612": 35},
        requested_lots={"AG2612": 40},
        current_lots={"AG2612": 35},
        lot_notionals={"AG2612": 1000.0},
        per_lot_margin={"AG2612": 100.0},
        soft_margin_budget=100000.0,
        objective=lambda lots: 1000.0 * lots.get("AG2612", 0),
    )
...
def test_optimizer_never_exceeds_two_x_gross():
    result = optimize(
        reference_lots={"AG2612": 9},
        requested_lots={"AG2612": 20},
        current_lots={"AG2612": 9},
        lot_notionals={"AG2612": 100000.0},
        per_lot_margin={"AG2612": 1000.0},
        equity=500000.0,
        soft_margin_budget=100000.0,
        objective=lambda lots: 1000.0 * lots.get("AG2612", 0),
    )
...
def test_optimizer_never_exceeds_supplied_soft_margin_budget():
    result = optimize(
        reference_lots={"AG2612": 2},
        requested_lots={"AG2612": 10},
        current_lots={"AG2612": 2},
        lot_notionals={"AG2612": 10000.0},
        per_lot_margin={"AG2612": 15000.0},
        soft_margin_budget=45000.0,
        objective=lambda lots: 1000.0 * lots.get("AG2612", 0),
    )
...
def test_optimizer_is_deterministic_on_equal_value_moves():
    result = optimize(
        reference_lots={},
        requested_lots={"AG2612": 1, "CU2610": 1},
        current_lots={},
        lot_notionals={"AG2612": 100000.0, "CU2610": 100000.0},
        per_lot_margin={"AG2612": 15000.0, "CU2610": 15000.0},
