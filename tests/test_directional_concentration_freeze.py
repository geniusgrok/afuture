...
def test_weak_leadership_freezes_entry_and_increase_but_preserves_reduction():
    ...
    assert increased == {"A2501": 5}
    assert reduced == {"A2501": 25}
